...
print(f"A soma entre os números {x1} e {x2} é: {soma}") 
# com tratamento da saída 'f' para 3 números após a vírgula
print(f'A divisão entre {x1} e {x2} é {div:.3}', end=' >>>Divisão com ponto flutuante<<< ')
print(f'A divisão entre {x1} e {x2} é {div:.3f}') #ponto flutuante, abrange 3 casas após a vírgula
